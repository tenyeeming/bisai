...
const i18n = {
  zh: {
    ...
    'round-face': '臉部',
    'round-tip-face': '這一穴在臉部正中，只有一個，按完一輪就完成。',
    ...
    'menu-fingers': '按摩手指',
    'finger-thumb': '拇指', 'finger-index': '食指', 'finger-middle': '中指', 'finger-ring': '無名指', 'finger-pinky': '小指',
    ...
    'settings-flow': '療程節奏',
    'settings-ready': '認穴停留',
    'settings-ready-desc': '認穴頁停留幾秒後自動進入定位。設 0 就直接跳過認穴 —— 但定位模型原本是趁你讀說明時在背景載的，跳過會讓定位頁開頭卡一下。',
    ...
    'settings-advance': '換穴',
    'settings-advance-desc': '一個穴道左右手都按完之後，要不要自動接下一個穴道。設「手動」就會停在完成頁等你點。按摩頁的齒輪也調得到，改的是同一項。',
    'settings-press': '單手秒數',
    'settings-press-desc': '一隻手按幾秒。左右各一輪，所以一個穴道的實際時間是這個數字的兩倍。這是「沒特別調過時」的預設值 —— 想讓某一穴久一點，在選穴頁按那一格的 ▾ 拉滑桿，只會影響那一穴。',
    'advance-auto': '自動',
    'advance-manual': '手動',
    // 我的流程（2026-09-08）
  ...
  en: {
    ...
    'round-face': 'Face',
    'round-tip-face': 'This point sits on the midline of the face. There is only one, so a single round completes it.',
    ...
    'finger-thumb': 'Thumb', 'finger-index': 'Index', 'finger-middle': 'Middle', 'finger-ring': 'Ring', 'finger-pinky': 'Pinky',
    ...
    'face-btn-peek': 'Preview locating only',
    ...
    'settings-ready-desc': 'Seconds to stay on the anatomy page before locating starts. Set 0 to skip it — but the hand model is normally loaded in the background while you read, so skipping makes locating stall for a moment.',
    ...
    'settings-advance-desc': 'Whether to continue to the next acupoint automatically once both hands are done. Set to Manual to stop on the completion page. The gear menu on the massage page changes the same setting.',
    'settings-press': 'Seconds per hand',
    'settings-press-desc': 'How long each hand presses. Both hands get a round, so one acupoint takes twice this. This is the default for points you have not tuned - to give one point longer, tap the arrow on its tile in the selection page and drag the slider.',
    'advance-auto': 'Auto',
